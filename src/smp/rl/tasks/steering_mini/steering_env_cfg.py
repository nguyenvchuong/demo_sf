"""mini steering task with SMP guidance.
...
guidance reward inherited from ``mini_smp_env_cfg``.
"""
...
def mini_steering_smp_env_cfg(play: bool = False) -> ManagerBasedRlEnvCfg:
  """Build the mini steering env cfg with SMP guidance."""
