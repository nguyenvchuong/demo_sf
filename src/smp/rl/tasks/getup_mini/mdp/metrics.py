...
from smp.robot.Mini_M1v1.mini_m11_constants import MINI_M1V1_XML
...
def mini_robot_body_names() -> list[str]:
  """Body names on Mini_M1v1 (excluding the world body)."""
  spec = mujoco.MjSpec.from_file(str(MINI_M1V1_XML))
