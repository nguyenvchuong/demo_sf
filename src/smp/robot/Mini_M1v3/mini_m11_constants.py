...
##
# Mini_M1v3.xml: 23dof
MINI_M1V3_XML: Path = Path("src/smp/robot/Mini_M1v3/Mini_M1v3.xml")
assert MINI_M1V3_XML.exists()


def get_spec() -> mujoco.MjSpec:
  return mujoco.MjSpec.from_file(str(MINI_M1V3_XML))
...
DAMPING_EC_A6416_P2_30_25H = (
  2.0 * DAMPING_RATIO * ARMATURE_EC_A6416_P2_30_25H * NATURAL_FREQ
)
DAMPING_EC_A6408_P2_30_25H = (
  2.0 * DAMPING_RATIO * ARMATURE_EC_A6408_P2_30_25H * NATURAL_FREQ
)
...
VELOCITY_LIMIT_EC_A4310_P2_36H = 12.5  # rad/s – small arm/ankle motor
...
# uncomment for 27dof
# MINI_M1V3_ACTUATOR_EC00 = BuiltinPositionActuatorCfg(
#   target_names_expr=(
#     ".*_wrist_yaw_joint",
#   ),
...
MINI_M1V3_ACTUATOR_EC_A8116_P1_18H = DcMotorActuatorCfg(
...
# MINI_M1V3_ACTUATOR_EC_ANKLE = DcMotorActuatorCfg(
...
MINI_M1V3_ACTUATOR_EC_ANKLE_PITCH = DcMotorActuatorCfg(
  target_names_expr=(".*_ankle_pitch_joint",),
  stiffness=STIFFNESS_EC_A4310_P2_36H,
  damping=DAMPING_EC_A4310_P2_36H * 2.5,
  effort_limit=24.0,
  # Ankle: 2 A4310 motors via 4-bar linkage, sum saturation effort.
...
MINI_M1V3_ARTICULATION = EntityArticulationInfoCfg(
  actuators=(
    MINI_M1V3_ACTUATOR_EC_A4310_P2_36H,
    MINI_M1V3_ACTUATOR_EC_A8116_P1_18H,
    MINI_M1V3_ACTUATOR_EC_A6416_P2_30_25H,
    MINI_M1V3_ACTUATOR_EC_A6408_P2_30_25H,
    MINI_M1V3_ACTUATOR_EC_ANKLE_PITCH,
    MINI_M1V3_ACTUATOR_EC_ANKLE_ROLL,
  ),
  soft_joint_pos_limit_factor=0.9,
)


def get_mini_m1v3_robot_cfg() -> EntityCfg:
  """Get a fresh Mini M1V3 robot configuration instance.
  ...
  return EntityCfg(
    ...
    spec_fn=get_spec,
    articulation=MINI_M1V3_ARTICULATION,
  )


MINI_M1V3_ACTION_SCALE: dict[str, float] = {}
for a in MINI_M1V3_ARTICULATION.actuators:
  ...
  for n in names:
    MINI_M1V3_ACTION_SCALE[n] = 0.25 * e / s
...
if __name__ == "__main__":
  ...
  robot = Entity(get_mini_m1v3_robot_cfg())
